...
function FeedPrecinctSplitCtrl($scope, $rootScope, $feedDataPaths, $feedsService, $routeParams, $appProperties, $location, $filter, ngTableParams) {
  ...
  $feedDataPaths.getResponse({ path: '/db/feeds/' + feedid + '/precinct-split/' + precinctsplitid,
                               scope: $rootScope,
  ...
  $feedDataPaths.getResponse({ path: '/db/feeds/' + feedid + '/precinct-split/' + precinctsplitid + '/electoral-districts',
                               scope: $rootScope,
