...
function FeedPollingLocationCtrl($scope, $rootScope, $feedDataPaths, $feedsService, $routeParams, $appProperties, $location, $filter, ngTableParams) {
  ...
  $feedDataPaths.getResponse({ path: '/db/v3/feeds/' + feedid + '/polling-locations/' + pollinglocationid,
                               scope: $rootScope,
  ...
  $feedDataPaths.getResponse({ path: '/db/v3/feeds/' + feedid + '/polling-locations/' + pollinglocationid + '/precincts',
                               scope: $rootScope,
                               key: 'feedPrecincts',
  ...
  $feedDataPaths.getResponse({ path: '/db/v3/feeds/' + feedid + '/polling-locations/' + pollinglocationid + '/precinct-splits',
                               scope: $rootScope,
