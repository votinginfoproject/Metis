...
function registerFeedsServices (app) {
  ...
  app.get('/services/feeds/:feedid/election/contests/:contestid/candidates', utils.ensureAuthentication, httpCallback.feedContestCandidatesGET);
  app.get('/services/feeds/:feedid/election/contests/:contestid/candidates/:candidateid', utils.ensureAuthentication, httpCallback.feedCandidateGET);
