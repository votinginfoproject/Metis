...
function registerFeedsServices (app) {
  ...
  app.get('/services/feeds/:feedid/election/state/localities/:localityid/precincts/:precinctid/electoraldistricts/:districtid/contests', utils.ensureAuthentication, httpCallback.feedPrecinctElectoralDistrictContestsGET);
  app.get('/services/feeds/:feedid/election/state/localities/:localityid/precincts/:precinctid/electoraldistricts/:districtid/precincts', utils.ensureAuthentication, httpCallback.feedPrecinctElectoralDistrictPrecinctsGET);
  app.get('/services/feeds/:feedid/election/state/localities/:localityid/precincts/:precinctid/electoraldistricts/:districtid/precinctsplits', utils.ensureAuthentication, httpCallback.feedPrecinctElectoralDistrictPrecinctSplitsGET);
  ...
  app.get('/services/feeds/:feedid/election/state/localities/:localityid/precincts/:precinctid/precinctsplits/:splitid/electoraldistricts/:districtid/contests', utils.ensureAuthentication, httpCallback.feedPrecinctSplitElectoralDistrictContestsGET);
  app.get('/services/feeds/:feedid/election/state/localities/:localityid/precincts/:precinctid/precinctsplits/:splitid/electoraldistricts/:districtid/precincts', utils.ensureAuthentication, httpCallback.feedPrecinctSplitElectoralDistrictPrecinctsGET);
  app.get('/services/feeds/:feedid/election/state/localities/:localityid/precincts/:precinctid/precinctsplits/:splitid/electoraldistricts/:districtid/precinctsplits', utils.ensureAuthentication, httpCallback.feedPrecinctSplitElectoralDistrictPrecinctSplitsGET);
  ...
  app.get('/services/feeds/:feedid/election/contests/:contestid/electoraldistrict/contests', utils.ensureAuthentication, httpCallback.feedContestElectoralDistrictContestsGET);
  app.get('/services/feeds/:feedid/election/contests/:contestid/electoraldistrict/precincts', utils.ensureAuthentication, httpCallback.feedContestElectoralDistrictPrecinctsGET);
  app.get('/services/feeds/:feedid/election/contests/:contestid/electoraldistrict/precinctsplits', utils.ensureAuthentication, httpCallback.feedContestElectoralDistrictPrecinctSplitsGET);
